  ...
  return (
    <div className="max-w-6xl mx-auto px-4">
      ...
      <motion.div
        ...
        className="relative flex flex-col items-center justify-center p-12 mb-20"
      >
        ...
        <div className="text-3xl text-center z-10">
          <motion.p
            ...
            className="mb-6 font-extrabold bg-gradient-to-r from-secondary to-primary text-transparent bg-clip-text"
          >
